...
[contact@awfixer.com]: mailto:termsofuse@legal.awfixer.com?subject=Terms-of-use-question
[Discord Server]: https://discord.awfixer.com
[Compliance Policies]: https://help.awfixer.com/legal/disclosures/law
[Data Handling Policies]: https://help.awfixer.com/legal/disclosures/data
[User Data Policies]: https://help.awfixer.com/legal/disclosures/user-data
[Entity Contributer License Agreement]: https://help.awfixer.com/legal/agreements/ecla
[Contributer License Agreement]: https://help.awfixer.com/legal/agreements/cla


<Warning>the AJ Services terms of use agreement is subject to update at any time with no prior warning to you or any other user of our services. You also agree to checking the policy regularly for updates in addition to the other terms in this policy.</Warning>

<Danger>This is a slightly modified Template at this time</Danger>

### TERMS OF USE

<Info>This Document is written in plain english, so it can be understood. If you have any questions you can ask them in our Discord.</Info>
...
We are AW&Friends, AWFixer and Friends, AJ Services ("Company," "we," "us," "our").

We operate the domains awfixer.com, awfixer.space, awfixer.email, awfixer.dev, awfixer.cloud, awfixer.me, awfixeros.site, modded-android.dev, awfixer.shop, awfixer.store, imjinx.lol, and more to be added at a later date. (the "Site or Sites"), the mobile applications AJ's Dash, Friend Dash, AWVPN, AWDNS, and more to be added at a later date (the "App or Apps"), as well as any other related products and services that refer or link to these legal terms (the "Legal Terms") (collectively, the "Services, Products, or Projects").

You can contact us by email at [contact@awfixer.com] or via our [Discord Server]
...
This may be done solely for your personal, non-commercial use or internal business purpose.
...
when you contribute and submit works to our services, products or projects you agree to be bound by our [Contributer License Agreement] or our [Entity Contributer License Agreement], whichever we find fits the contributions.
...
By uploading content to our services you grant us a restricted, non sublicensable, irrevokable license to use, store, transmit and duplicate your content in accordance to our [User Data Policies], [Data Handling Policies], and [Compliance Policies]
